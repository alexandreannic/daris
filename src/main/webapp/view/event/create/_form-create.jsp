...
<form:form id='event-form' method='POST' action='/daris/event/add' commandName='event'>
	...
	<div id='activity-container'>
			<div class='form-field'>
				...
				<form:input type='hidden' id='addEvent-locality-id0 ' path='activities[0].locality.id' value='1'/>
			</div>
			
			<div class='form-field'>
				<label for='addActivity-from'><spring:message code='event.activity.field.from'/></label>
				<input id='addEvent-from0 ' name='activities[0].from' value="2015-01-01"/>
			</div>
				
			<div class='form-field'>
				<label for='addActivity-to'><spring:message code='event.activity.field.to'/></label>
				<input id='addEvent-to0 ' name='activities[0].to' value="2015-01-01"/>
			</div>
...
<!-- 			<div class='form-field'> -->
<%-- 				<label for='addActivity-from'><spring:message code='event.activity.field.from'/></label> --%>
<!-- 				<input id='addEvent-from0' name='activities[1].from' value="2015-01-01"/> -->
<!-- 			</div> -->
				
<!-- 			<div class='form-field'> -->
<%-- 				<label for='addActivity-to'><spring:message code='event.activity.field.to'/></label> --%>
<!-- 				<input id='addEvent-to0 ' name='activities[1].to' value="2015-01-01"/> -->
<!-- 			</div> -->
	</div>
...
<%@ include file='_script-pop-activity.jsp'%>
